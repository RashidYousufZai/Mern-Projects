    ...
    <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
      ...
      <div className='flex flex-col'>
        <div className='flex items-center space-x-4 md:space-x-8'>
            <input onChange={(e)=>setCat(e.target.value)}  className='px-4 py-2 outline-none' placeholder='Enter post category' type="text"/>
      ...
      <button onClick={handleClick}  className='bg-black w-full mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg'>Create</button>
    </form>
